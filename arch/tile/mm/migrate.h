 ...
 *  - Do a cache-evict on any necessary cpus if cache_cpumask != NULL.
 *  - Call finv_buffer_remote(finv_va, THREAD_SIZE, 0) if finv_va != 0.
...
extern int homecache_migrate_stack_and_flush(pte_t stack_pte, unsigned long va,
				     ...
				     int asidcount, unsigned long finv_va);
