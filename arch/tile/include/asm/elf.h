...
#define ELF_FLAGS_ISE0 (1 << EF_TILEGX_ISE0)
#else
#define ELF_FLAGS_ISE0 0
#endif


#define ELF_FLAGS_ISE1 (1 << EF_TILEGX_ISE1)
...
#define elf_check_arch(x)  \
	((x)->e_ident[EI_CLASS] == ELF_CLASS && \
	 ...
	 ((x)->e_flags & (ELF_FLAGS_ISE0 | ELF_FLAGS_ISE1)) == 0)
...
do { \
	set_personality((current->personality & ~PER_MASK) | PER_LINUX_32BIT);\
	current_thread_info()->status |= TS_COMPAT; \
} while (0)
