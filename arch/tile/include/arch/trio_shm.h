...
typedef union
{
  struct
  {
     ...
     * buffer contain the next buffer descriptor formatted exactly like a
     * mPIPE buffer descriptor.  This allows a chained mPIPE buffer to be
     * sent using push DMA.
     */
    uint_reg_t c     : 1;
    /**
