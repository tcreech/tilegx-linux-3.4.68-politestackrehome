...
typedef union
{
  struct
  {
     ...
     * When setting ENA to 1, the BAR0_MASK must be written again after the
     * ENA is written to set the size.
     */
    uint_reg_t ena          : 1;
    /* Reserved. */
     ...
     * be 8 MB, the MASK field would be set to 0x7fff
     */
    uint_reg_t mask         : 24;
    /* Reserved. */
...
typedef union
{
  struct
  {
     ...
     * When setting ENA to 1, the BAR2_MASK must be written again after the
     * ENA is written to set the size.
     */
    uint_reg_t ena          : 1;
    /* Reserved. */
     ...
     * be 256 MB, the MASK field would be set to 0xfffff
     */
    uint_reg_t mask         : 24;
    /* Reserved. */
    uint_reg_t __reserved_1 : 32;
...
typedef union
{
  struct
  {
    ...
    uint_reg_t io         : 1;
    /*
     * If BAR 0 is a memory BAR, bits [2:1] determine the BAR type:   0 =
     * 32-bit BAR   2 = 64-bit BAR  If BAR 0 is an I/O BAR, bit 2 the least
     ...
     * bits are in BAR 1). BAR0 is 8 MB by default.  The BAR0_MASK register,
...
typedef union
{
  struct
  {
    ...
    uint_reg_t mem        : 1;
    /*
     * If BAR 2 is a memory BAR, bits [2:1] determine the BAR type:   0 =
     * 32-bit BAR   2 = 64-bit BAR  If BAR 2 is an I/O BAR, bit 2 the least
     * significant  bit of the base address and bit 1 is 0.  Bits [3:0] are
     * Writable through the MAC_STANDARD interface.
     */
    uint_reg_t is_64_bit  : 2;
    /*
     * If BAR 2 is a memory BAR, bit 3 indicates if the memory region is
     ...
     * bits are in BAR 3). BAR2 is 128 MB by default. The BAR2_MASK register,
     * accessible via MAC_PROTECTED space, determines which address bits are
     * masked and thus the BAR size.
     */
    uint_reg_t addr       : 28;
...
#ifndef __BIG_ENDIAN__
    /*
     * BAR 2 is a 64-bit BAR so BAR 3 contains the upper 32 bits of the BAR 2
     * base address (bits [63:32]).
     */
    uint_reg_t val        : 32;
    /* Reserved. */
...
typedef union
{
  struct
  {
    ...
    /*
     * Endpoint L0s Acceptable Latency, writable through the MAC_STANDARD
     * interface
     */
    uint_reg_t l0s_lat                    : 3;
    /*
     * Endpoint L1 Acceptable Latency, writable through the MAC_STANDARD
     * interface
     */
    uint_reg_t l1_lat                     : 3;
    /*
...
typedef union
{
  struct
  {
     ...
     * is chosen, the MAC will have a timeout  in the range of 16 ms to 55 ms.
     */
...
typedef union
{
  ...
  uint_reg_t word;
} TRIO_PCIE_EP_IATU_LIMIT_ADDRESS_t;
...
typedef union
{
  ...
  uint_reg_t word;
} TRIO_PCIE_EP_IATU_LOWER_BASE_ADDRESS_t;
...
typedef union
{
  ...
  uint_reg_t word;
} TRIO_PCIE_EP_IATU_OUTBOUND_REGION_LO_ADDRESS_t;
...
#ifndef __BIG_ENDIAN__
    /*
     * Used to indicate how many VFs are available to the host.  Writable
     * through the MAC_STANDARD interface.  See PCIe SRIOV specification.
     */
...
#ifndef __BIG_ENDIAN__
    /*
     * NumVFs, writable through the MAC_STANDARD interface, though is
     * typically written by BIOS software.  See PCIe SRIOV specification.
     */
    uint_reg_t val        : 16;
    /* Reserved. */
    uint_reg_t __reserved : 48;
...
typedef union
{
...
#ifndef __BIG_ENDIAN__
    /* PF Device Serial Number Capability Register. */
    uint_reg_t pf_device_serial_number_cap : 64;
#else   /* __BIG_ENDIAN__ */
    uint_reg_t pf_device_serial_number_cap : 64;
#endif
  };
  ...
  uint_reg_t word;
} TRIO_PCIE_EP_PF_DEVICE_SERIAL_NUMBER_CAP_t;
...
typedef union
{
...
#ifndef __BIG_ENDIAN__
    /* PF Power Budgeting Capability Register. */
    uint_reg_t pf_power_budgeting_cap : 64;
#else   /* __BIG_ENDIAN__ */
    uint_reg_t pf_power_budgeting_cap : 64;
#endif
  };
  ...
  uint_reg_t word;
} TRIO_PCIE_EP_PF_POWER_BUDGETING_CAP_t;
...
typedef union
{
  ...
  {
#ifndef __BIG_ENDIAN__
    /* Always zero.  IO BARs are not supported for SRIOV. */
    uint_reg_t io         : 1;
    /*
     * If VF BAR0 is a memory BAR, bits [2:1] determine the BAR type:   0 =
     * 32-bit BAR   2 = 64-bit BAR .  This field is writable through the
     * MAC_STANDARD interface.
     */
    uint_reg_t is_64_bit  : 2;
    /*
     * If VF BAR0 is a memory BAR, bit 3 indicates if the memory region is
     * prefetchable:   0 = Non-prefetchable   1 = Prefetchable.  This field
     * is writable through the MAC_STANDARD interface.
     */
    uint_reg_t pref       : 1;
    /*
     * VF BAR0 base address (for a 64-bit BAR, the remaining upper address
     * bits are in BAR 1).  VF BAR0 is 1 MB by default.  The VF_BAR0_MASK
     * register, accessible via MAC_PROTECTED space, determines which address
     * bits are masked and thus the BAR size.
     */
    uint_reg_t vf_bar0    : 28;
    /* Reserved. */
    uint_reg_t __reserved : 32;
#else   /* __BIG_ENDIAN__ */
    uint_reg_t __reserved : 32;
...
typedef union
{
  struct
  {
    ...
    uint_reg_t __reserved_0 : 7;
    /*
     * Indicates which BAR0 address to mask.  For example, to set BAR0 to be
     * 8 MB, the MASK field would be set to 0x7fff
     */
    uint_reg_t mask         : 24;
    /* Reserved. */
    uint_reg_t __reserved_1 : 32;
...
typedef union
{
  struct
  {
    ...
    uint_reg_t io         : 1;
    /*
     * If VF BAR1 is a memory BAR, bits [2:1] determine the BAR type:   0 =
     * 32-bit BAR   2 = 64-bit BAR .  This field is writable through the
     * MAC_STANDARD interface.
     */
    uint_reg_t is_64_bit  : 2;
    /*
     * If VF BAR1 is a memory BAR, bit 3 indicates if the memory region is
     * prefetchable:   0 = Non-prefetchable   1 = Prefetchable.  This field
     * is writable through the MAC_STANDARD interface.
     */
    uint_reg_t pref       : 1;
    /*
     * VF BAR1 base address (for a 64-bit BAR0, this register has the upper
     * 32 bits).  VF BAR1 is 1 MB by default.  The VF_BAR1_MASK register,
     * accessible via MAC_PROTECTED space, determines which address bits are
     * masked and thus the BAR size.
     */
    uint_reg_t vf_bar1    : 28;
    /* Reserved. */
    uint_reg_t __reserved : 32;
#else   /* __BIG_ENDIAN__ */
    uint_reg_t __reserved : 32;
...
typedef union
{
  struct
  {
#ifndef __BIG_ENDIAN__
    /*
     * When 1, bar1 is enabled.  When 0, the MASK is reset to all zeros.
     * When setting ENA to 1, the BAR1_MASK must be written again after the
     * ENA is written to set the size.
     */
    uint_reg_t ena          : 1;
    /* Reserved. */
    uint_reg_t __reserved_0 : 7;
    /*
     * Indicates which BAR1 address to mask.  For example, to set BAR1 to be
     * 8 MB, the MASK field would be set to 0x7fff
     */
    uint_reg_t mask         : 24;
    /* Reserved. */
...
typedef union
{
  struct
  {
    ...
    uint_reg_t io         : 1;
    /*
     * If VF BAR2 is a memory BAR, bits [2:1] determine the BAR type:   0 =
     * 32-bit BAR   2 = 64-bit BAR .  This field is writable through the
     * MAC_STANDARD interface.
     */
    uint_reg_t is_64_bit  : 2;
    /*
     * If VF BAR2 is a memory BAR, bit 3 indicates if the memory region is
     * prefetchable:   0 = Non-prefetchable   1 = Prefetchable.  This field
     * is writable through the MAC_STANDARD interface.
     */
    uint_reg_t pref       : 1;
    /*
     * VF BAR2 base address (for a 64-bit BAR, the remaining upper address
     * bits are in BAR 3).  VF BAR2 is 32 MB by default.  The VF_BAR2_MASK
     * register, accessible via MAC_PROTECTED space, determines which address
     * bits are masked and thus the BAR size.
     */
    uint_reg_t vf_bar2    : 28;
    /* Reserved. */
    uint_reg_t __reserved : 32;
#else   /* __BIG_ENDIAN__ */
    uint_reg_t __reserved : 32;
...
typedef union
{
  struct
  {
    ...
    uint_reg_t __reserved_0 : 7;
    /*
     * Indicates which BAR2 address to mask.  For example, to set BAR2 to be
     * 8 MB, the MASK field would be set to 0x7fff
     */
    uint_reg_t mask         : 24;
    /* Reserved. */
...
typedef union
{
  struct
  {
    ...
    uint_reg_t io         : 1;
    /*
     * If VF BAR3 is a memory BAR, bits [2:1] determine the BAR type:   0 =
     * 32-bit BAR   2 = 64-bit BAR .  This field is writable through the
     * MAC_STANDARD interface.
     */
    uint_reg_t is_64_bit  : 2;
    /*
     * If VF BAR3 is a memory BAR, bit 3 indicates if the memory region is
     * prefetchable:   0 = Non-prefetchable   1 = Prefetchable.  This field
     * is writable through the MAC_STANDARD interface.
     */
    uint_reg_t pref       : 1;
    /* VF BAR3 base address. */
    uint_reg_t vf_bar3    : 28;
    /* Reserved. */
    uint_reg_t __reserved : 32;
#else   /* __BIG_ENDIAN__ */
    uint_reg_t __reserved : 32;
...
#ifndef __BIG_ENDIAN__
    /*
     * When 1, bar3 is enabled.  When 0, the MASK is reset to all zeros.
     * When setting ENA to 1, the BAR3_MASK must be written again after the
     * ENA is written to set the size.
     */
    uint_reg_t ena          : 1;
    /* Reserved. */
    uint_reg_t __reserved_0 : 7;
    /* Indicates which BAR3 address to mask. */
    uint_reg_t mask         : 24;
    /* Reserved. */
    uint_reg_t __reserved_1 : 32;
#else   /* __BIG_ENDIAN__ */
...
typedef union
{
  struct
  {
    ...
    uint_reg_t io         : 1;
    /*
     * If VF BAR4 is a memory BAR, bits [2:1] determine the BAR type:   0 =
     * 32-bit BAR   2 = 64-bit BAR .  This field is writable through the
     * MAC_STANDARD interface.
     */
    uint_reg_t is_64_bit  : 2;
    /*
     * If VF BAR4 is a memory BAR, bit 3 indicates if the memory region is
     * prefetchable:   0 = Non-prefetchable   1 = Prefetchable.  This field
     * is writable through the MAC_STANDARD interface.
     */
    uint_reg_t pref       : 1;
    /* VF BAR4 base address. */
    uint_reg_t vf_bar4    : 28;
    /* Reserved. */
    uint_reg_t __reserved : 32;
#else   /* __BIG_ENDIAN__ */
    uint_reg_t __reserved : 32;
...
typedef union
{
  struct
  {
#ifndef __BIG_ENDIAN__
    /*
     * When 1, bar4 is enabled.  When 0, the MASK is reset to all zeros.
     * When setting ENA to 1, the BAR4_MASK must be written again after the
     * ENA is written to set the size.
     */
    uint_reg_t ena          : 1;
    /* Reserved. */
    uint_reg_t __reserved_0 : 7;
    /*
     * Indicates which BAR4 address to mask.  For example, to set BAR4 to be
     * 8 MB, the MASK field would be set to 0x7fff
     */
    uint_reg_t mask         : 24;
    /* Reserved. */
...
typedef union
{
  struct
  {
    ...
    uint_reg_t io         : 1;
    /*
     * If VF BAR5 is a memory BAR, bits [2:1] determine the BAR type:   0 =
     * 32-bit BAR   2 = 64-bit BAR .  This field is writable through the
     * MAC_STANDARD interface.
     */
    uint_reg_t is_64_bit  : 2;
    /*
     * If VF BAR5 is a memory BAR, bit 3 indicates if the memory region is
     * prefetchable:   0 = Non-prefetchable   1 = Prefetchable.  This field
     * is writable through the MAC_STANDARD interface.
     */
    uint_reg_t pref       : 1;
    /* VF BAR5 base address . */
    uint_reg_t vf_bar5    : 28;
    /* Reserved. */
    uint_reg_t __reserved : 32;
#else   /* __BIG_ENDIAN__ */
    uint_reg_t __reserved : 32;
...
#ifndef __BIG_ENDIAN__
    /*
     * When 1, bar5 is enabled.  When 0, the MASK is reset to all zeros.
     * When setting ENA to 1, the BAR5_MASK must be written again after the
     * ENA is written to set the size.
     */
    uint_reg_t ena          : 1;
    /* Reserved. */
    uint_reg_t __reserved_0 : 7;
    /* Indicates which BAR5 address to mask. */
    uint_reg_t mask         : 24;
    /* Reserved. */
    uint_reg_t __reserved_1 : 32;
#else   /* __BIG_ENDIAN__ */
