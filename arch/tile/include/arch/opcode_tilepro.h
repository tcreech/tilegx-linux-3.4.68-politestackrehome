...
#define TILEPRO_MAX_INSTRUCTIONS_PER_BUNDLE 3

/* How many different pipeline encodings are there? X0, X1, Y0, Y1, Y2. */
#define TILEPRO_NUM_PIPELINE_ENCODINGS 5

/* Log base 2 of TILEPRO_BUNDLE_SIZE_IN_BYTES. */
#define TILEPRO_LOG2_BUNDLE_SIZE_IN_BYTES 3

/* Instructions take this many bytes. */
#define TILEPRO_BUNDLE_SIZE_IN_BYTES \
  (1 << TILEPRO_LOG2_BUNDLE_SIZE_IN_BYTES)

/* Log base 2 of TILEPRO_BUNDLE_ALIGNMENT_IN_BYTES. */
#define TILEPRO_LOG2_BUNDLE_ALIGNMENT_IN_BYTES 3

/* Bundles should be aligned modulo this number of bytes. */
#define TILEPRO_BUNDLE_ALIGNMENT_IN_BYTES \
  (1 << TILEPRO_LOG2_BUNDLE_ALIGNMENT_IN_BYTES)

/* Log base 2 of TILEPRO_SN_INSTRUCTION_SIZE_IN_BYTES. */
#define TILEPRO_LOG2_SN_INSTRUCTION_SIZE_IN_BYTES 1

/* Static network instructions take this many bytes. */
#define TILEPRO_SN_INSTRUCTION_SIZE_IN_BYTES \
  (1 << TILEPRO_LOG2_SN_INSTRUCTION_SIZE_IN_BYTES)

/* Number of registers (some are magic, such as network I/O). */
#define TILEPRO_NUM_REGISTERS 64

/* Number of static network registers. */
#define TILEPRO_NUM_SN_REGISTERS 4
