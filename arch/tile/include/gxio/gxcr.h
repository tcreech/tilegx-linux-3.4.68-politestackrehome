 ...
 * @param len Length, in bytes, of the data to be processed.
 */
extern int gxcr_do_init_op(gxio_mica_context_t * mica_context,
			   gxcr_context_t * crypto_context,
			   void *src, void *dst, int len);
 ...
 * @param len Length, in bytes, of the data to be processed.
 */
extern int gxcr_do_update_op(gxio_mica_context_t * mica_context,
			     gxcr_context_t * crypto_context,
			     void *src, void *dst, int len);
 ...
 * @param len Length, in bytes, of the data to be processed.
 */
extern int gxcr_do_final_op(gxio_mica_context_t * mica_context,
			    gxcr_context_t * crypto_context,
			    void *src, void *dst, int len);
