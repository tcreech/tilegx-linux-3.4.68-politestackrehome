...
#ifdef CONFIG_USB_GADGET_TILEGX

static struct tilegx_usb_platform_data tilegx_udc_info = {
	.dev_index = 0,
};

static struct platform_device tilegx_device_udc = {
	.name		= "tile-usbgadget",
	.id		= 0,
	.dev		=  {
		.platform_data	= &tilegx_udc_info,
		.dma_mask	= 0,
	},
};
