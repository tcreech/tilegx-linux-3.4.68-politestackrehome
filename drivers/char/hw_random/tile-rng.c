...
static uint num_hw_trngs = 1;

module_param(num_hw_trngs, uint, 0444);
MODULE_PARM_DESC(num_hw_trngs, "number of hardware true random number "
		 "generators to reserve for use by Linux driver");
